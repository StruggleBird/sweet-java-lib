...
public final class Hash {
    ...
    /**
     * 64-bit hash, using longs, in stead of ints, for less collisions, for when it matters. Calls
    ...
    /**
     * Same as longHash(String), using only lower-case values of letters. Calls longhash( s , 0 ,
     * s.length() ).
     * 
     * @param s The string to Hash.
     * @return the hash code
    ...
    /**
     * This is an exact copy of the String <code>hashCode()</code> function, aside from the
     * lowercasing.
     * 
    ...
    /**
     * This is an exact copy of the String <code>hashCode()</code> function, aside from the
     * lowercasing. No, it's not. It also ignores consecutive whitespace.
     * 
     * @param s string to be hashed
     * @return the hash code
     */

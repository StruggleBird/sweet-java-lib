...
public class IOs {
     ...
     * truncation before using {@link IOs#toByteArray(java.io.InputStream, int)} to read into the
     * byte array. (Arrays can have no more than Integer.MAX_VALUE entries anyway)
     * 
     * @param input the <code>InputStream</code> to read from
     ...
     *         Integer.MAX_VALUE
     * @see IOs#toByteArray(java.io.InputStream, int)
     * @since 2.1
     */
    ...
    /**
     * Get the contents of a <code>String</code> as a <code>byte[]</code> using the default
     * character encoding of the platform.
     * <p>
    ...
    /**
     * Get the contents of a <code>byte[]</code> as a String using the default character encoding of
     * the platform.
     * 
